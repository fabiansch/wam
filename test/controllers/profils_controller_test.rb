...
class ProfilsControllerTest < ActionController::TestCase
  ...
  test "should create profil" do
    assert_difference('Profil.count') do
      post :create, profil: { aboutme: @profil.aboutme, city: @profil.city, email: @profil.email, job: @profil.job, name: @profil.name }
    end
  ...
  test "should update profil" do
    patch :update, id: @profil, profil: { aboutme: @profil.aboutme, city: @profil.city, email: @profil.email, job: @profil.job, name: @profil.name }
    assert_redirected_to profil_path(assigns(:profil))
  end
